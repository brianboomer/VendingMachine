...
namespace Capstone
{
	...
	{
		//property
		public static Dictionary<string, List<Item>> ItemsInventory { get; set; }

		//constructor
		public Inventory(Dictionary<string, List<Item>> itemsInventory)
		{
			ItemsInventory = itemsInventory;
		}

		public static void InitalizeInventory()
